...
function Node(value, index, depth, cx, cy, left, right, regfill){
    this.value = value;
    this.index = index;
    this.depth = depth;
    this.radius = radius;
...
function Tree() {
    ...
    this.createBinarySearchTree = function(inputArr){
        ...
        this.nodes = treeContainer.selectAll("text.circle").raise()
...
var elementsArr = arrayContainer.selectAll("rect").data(arrayData).enter().append("rect").on("click", addHighlight);
